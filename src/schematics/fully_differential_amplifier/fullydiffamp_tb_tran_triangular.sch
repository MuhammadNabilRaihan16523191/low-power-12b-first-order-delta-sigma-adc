...
C {vsource.sym} -330 115 0 0 {name=V7 value="PULSE(1.65002 1.64998 0 250u 250u 0 500u)" savecurrent=false}
C {gnd.sym} -330 165 0 0 {name=l12 lab=GND
value="PULSE(20u -20u 0 1n 1n 100u 200u)"}
C {vsource.sym} -65 120 0 0 {name=V6 value="PULSE(1.64998 1.65002 0 250u 250u 0 500u)" savecurrent=false}
