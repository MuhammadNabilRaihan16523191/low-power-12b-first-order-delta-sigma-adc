...
N 420 -590 420 -410 {lab=#net1}
N 360 -260 360 -80 {lab=VREF-}
N 420 -260 420 -80 {lab=#net1}
N 390 -370 390 -300 {lab=#net2}
N 240 -480 240 -210 {lab=#net2}
N 240 -340 390 -340 {lab=#net2}
...
N 420 -500 500 -500 {lab=#net1}
N 420 -180 490 -180 {lab=#net1}
N 500 -500 500 -180 {lab=#net1}
N 490 -180 500 -180 {lab=#net1}
...
N 590 -490 590 -220 {lab=#net3}
N 590 -160 590 -130 {lab=VSS}
N 590 -570 590 -550 {lab=VDD}
N 590 -190 610 -190 {lab=VSS}
N 610 -190 610 -140 {lab=VSS}
N 590 -140 610 -140 {lab=VSS}
N 590 -520 600 -520 {lab=VDD}
N 600 -560 600 -520 {lab=VDD}
N 590 -560 600 -560 {lab=VDD}
N 830 -340 860 -340 {lab=VOUT}
N 250 -670 250 -550 {lab=VDD}
N 250 -670 580 -670 {lab=VDD}
N 580 -670 590 -670 {lab=VDD}
N 590 -670 590 -570 {lab=VDD}
N 260 -130 590 -130 {lab=VSS}
N 520 -520 520 -340 {lab=#net1}
N 520 -520 550 -520 {lab=#net1}
N 520 -190 550 -190 {lab=#net1}
N 520 -340 520 -190 {lab=#net1}
N 740 -340 760 -340 {lab=#net3}
N 830 -490 830 -220 {lab=VOUT}
N 830 -160 830 -130 {lab=VSS}
N 830 -570 830 -550 {lab=VDD}
N 830 -190 850 -190 {lab=VSS}
N 850 -190 850 -140 {lab=VSS}
N 830 -140 850 -140 {lab=VSS}
N 830 -520 840 -520 {lab=VDD}
N 840 -560 840 -520 {lab=VDD}
N 830 -560 840 -560 {lab=VDD}
N 820 -670 830 -670 {lab=VDD}
N 830 -670 830 -570 {lab=VDD}
N 760 -520 760 -340 {lab=#net3}
N 760 -520 790 -520 {lab=#net3}
N 760 -190 790 -190 {lab=#net3}
N 760 -340 760 -190 {lab=#net3}
N 590 -670 820 -670 {lab=VDD}
N 590 -130 830 -130 {lab=VSS}
N 590 -340 740 -340 {lab=#net3}
...
C {opin.sym} 860 -340 0 0 {name=p4 lab=VOUT}
...
C {symbols/pfet_03v3.sym} 570 -520 0 0 {name=M7
L=Ld
W=Wsp_p
nf=1
mult=1
...
C {symbols/nfet_03v3.sym} 570 -190 0 0 {name=M8
L=Ld
W=Wsn_p
nf=1
mult=1
...
C {symbols/pfet_03v3.sym} 810 -520 0 0 {name=M9
L=Ld
W=Wsp2_p
nf=1
mult=1
...
C {symbols/nfet_03v3.sym} 810 -190 0 0 {name=M10
L=Ld
W=Wsn2_p
nf=1
mult=1
